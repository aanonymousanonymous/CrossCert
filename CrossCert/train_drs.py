...
from utils.drs import gen_ablation_set, random_one_ablation

parser = argparse.ArgumentParser()
parser.add_argument("--model_dir",default='checkpointsss',type=str)
...
if args.cutout:
    ...
    model_name = args.model + '_{}_drs_{}_{}.pth'.format(args.dataset,args.ablation_size,args.dataset)
print(model_name)
device = 'cuda'
...
# get data loader
if args.dataset in ['imagenette','flower102','imagenet']:
...
elif args.dataset in ['cifar','cifar100','svhn','gtsrb']:
